...
@section('judul','Laporan Mingguan')
...
<form method="POST" action="<?= base_url() ?>pimpinan/laporan/cetak_mingguan">
	<div class="row">
		<div class="form-group">
			<label for="weekstart">week start </label>
			<input class="form-control" name="week_start" type="date">
		</div>
		<div class="form-group">
			<label for="weekend">week end </label>
			<input class="form-control" name="week_end" type="date">
		</div>
		<br>
	</div>
