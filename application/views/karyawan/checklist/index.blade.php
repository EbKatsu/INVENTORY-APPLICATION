...
<div class="container1">
	<a class="btn btn-info" href="{{ base_url() }}karyawan/checklist/tambah"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
...
<div class="container2">
	...
	<table class="table table-hover">
		...
		foreach ($produk as $a) : ?>
			<tr>
				<td><?= $no++ ?> </td>
				<td><a class='btn btn-warning' style='background-color:orangered' href='detail_checklist/index/<?= $a->id_produk ?>'><?= $a->nama_produk ?> <span class='glyphicon glyphicon-pencil'></span></a></td>
