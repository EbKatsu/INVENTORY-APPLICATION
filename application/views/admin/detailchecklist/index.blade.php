...
<div class="container1">
	<br>
	<a class="btn btn-info" href="{{ base_url() }}admin/detail_checklist/tambah/<?= $id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
...
<div class="container2">
	...
	<form action="<?= base_url() ?>admin/detail_checklist/update" id="form-tambah" method="POST">
