			...
			<div id="content">
				<nav class="navbar navbar-light" style="background-color: #fff">
					<div class="container-fluid">
						...
						<form class="d-flex">
							<button class="btn btn-success me-2" type="submit"><a role="button" href="{{ base_url() }}admin/profile" style="color: white;text-decoration: none;">Hy, <?= $_SESSION['username'] ?> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
