...
class Laporan extends MY_Controller
{
	...
	public function index()
	{
		...
		echo $this->view('pimpinan/laporan/index');
	}
	public function harian()
	{

		echo $this->view('pimpinan/laporan/mingguan');
	}

	public function bulanan()
	{
		echo $this->view('pimpinan/laporan/bulanan');
	}

	public function tahunan()
	{
		echo $this->view('pimpinan/laporan/tahunan');
	}
